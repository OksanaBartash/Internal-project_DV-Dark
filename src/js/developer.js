...
let Arr_Active_Techno = ['src/img/developers/T1-active.svg', 'src/img/developers/T2-active.svg', 'src/img/developers/T3-active.svg', 'src/img/developers/T4-active.svg', 'src/img/developers/T5-active.svg', 'src/img/developers/T6-active.svg', 'src/img/developers/T7-active.svg', 'src/img/developers/T8-active.svg', 'src/img/developers/T9-active.svg'];
let Arr_Techno = ['src/img/developers/T1.svg', 'src/img/developers/T2.svg', 'src/img/developers/T3.svg', 'src/img/developers/T4.svg', 'src/img/developers/T5.svg', 'src/img/developers/T6.svg', 'src/img/developers/T7.svg', 'src/img/developers/T8.svg', 'src/img/developers/T9.svg'];
